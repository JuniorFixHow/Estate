...
const Check = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_ao62hw5', 'template_yqn7qtm', e.target, 'GjRd2PvMRjAnYMknX')
        .then((result) => {
        ...
        <div className="container">
            <div className="top">
                ...
                <div className="right">
                    ...
                    <div className="links">
                        <div className="phone">
                            <a href="tel:+233 541 097 145"><BsFillTelephoneFill className='call' /></a>
                            <h6>+233 541 097 145</h6>
                        </div>
                        <div className="icons">
                            <a target='_blank' href="https://api.whatsapp.com/send?phone=+233541097145"><BsWhatsapp className='what'/></a>
